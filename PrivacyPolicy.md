...
2.1 Настоящая Политика направлена на защиту прав и свобод физических лиц, персональные данные которых обрабатывает Оператор.
...
2.4 Контактные данные Оператора:
...
2.8 В случае несогласия с условиями, пользователь должен воздержаться от использования бота и ни в коем случае не предоставлять Оператору свои персональные данные.
...
5.1 К категориям субъектов персональных данных, чьи персональные данные обрабатываются Оператором, относятся Пользователи.
